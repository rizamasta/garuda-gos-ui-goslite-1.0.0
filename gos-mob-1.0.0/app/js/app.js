...
var App = angular.module('angle', ['ngRoute', 'ngAnimate', 'ngStorage', 'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router', 'oc.lazyLoad', 'cfp.loadingBar', 'ngSanitize', 'ngResource'])
          .run(["$rootScope", "$state", "$stateParams",  '$window', '$templateCache', function ($rootScope, $state, $stateParams, $window, $templateCache) {
              ...
              localStorage.setItem('UserName','SA3ADGM');
              localStorage.setItem('Password','SA3ADGMGOS2011');

              $rootScope.$state = $state;
              $rootScope.$stateParams = $stateParams;
              $rootScope.$storage = $window.localStorage;
              $rootScope.basURL ="http://localhost/gos-mob/#/gos";
              ...
              $rootScope.app = {
                name: 'Gos',
                description: 'Lightweight version of GOS',
...
App.controller('LoginFormController', ['$scope', '$http', '$state', function($scope, $http, $state) {
  ...
  $scope.login = function() {
    ...
    $http
      .post('api/login.php', {email: $scope.account.email, password: $scope.account.password})
      .then(function(response) {
        // assumes if ok, response is an object with some data, if not, a string with error
        // customize according to your api
        if ( !response.account ) {
          $scope.authMsg = response;//'Incorrect credentials.';
        }else{
...
/*
=============================================
	controller datepicker for departure and Return
    pickDate.js
=============================================
*/
...
==========================================================================
 ...
 ==========================================================================
*/
App.controller('ProfileGOSController',["$scope", "$http", function($scope,$http){
